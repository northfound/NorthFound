...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages = ["", "/collections/kitchen", "/collections/pantry", "/collections/laundry", "/method", "/recommendations", "/journal", "/about", "/privacy", "/affiliate-disclosure"].map((path) => ({ url: `${base}${path}` }));
